...
rem 定义仓库地址，每行一个
set "repo[1]=git@github.com:meimolihan/compose.git"
set "repo[2]=git@github.com:meimolihan/hexo-main.git"
set "repo[3]=git@github.com:meimolihan/sh.git"
set "repo[4]=git@github.com:meimolihan/file.git"
set "repo[5]=git@github.com:meimolihan/cdn.git"
set "repo[6]=git@github.com:meimolihan/music.git"
set "repo[7]=git@github.com:meimolihan/hugo-main.git"
set "repo[8]=git@github.com:meimolihan/random-pic-api.git"
set "repo[9]=git@github.com:meimolihan/video.git"
